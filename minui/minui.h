...
int res_create_display_surface(const char *name, const char *dir,
                                gr_surface *pSurface, const bool dofree);
...
int res_create_alpha_surface(const char* name, const char *dir,
                                        gr_surface* pSurface);
...
int res_create_localized_alpha_surface(const char* name, const char *dir,
